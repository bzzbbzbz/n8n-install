...
**Left4Casino** — Telegram-бот для виртуального казино с ИИ-банкиром, системой ставок, переводами между игроками и ежедневной статистикой. Проект построен на `aiogram 3.x` с асинхронной архитектурой.
...
┌──────────────────────────▼──────────────────────────────────┐
│                       Services                               │
│         AIClient │ DailyStatsService │ GroupTracker          │
└──────────────────────────┬──────────────────────────────────┘
                           │
┌──────────────────────────▼──────────────────────────────────┐
│                    Database (SQLite)                         │
...
| `event_history` | Лог всех событий: win/loss/transfer/bankruptcy/dice_challenge_* |
